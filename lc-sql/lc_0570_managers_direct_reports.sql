-- SCHEMA
-- Employee table already used in LC 0577
...
insert into Employee2 (id, name, department, managerId) values ('107', 'John', 'A', NULL);
insert into Employee2 (id, name, department, managerId) values ('108', 'Dan', 'A', '107');
insert into Employee2 (id, name, department, managerId) values ('109', 'James', 'A', '107');
insert into Employee2 (id, name, department, managerId) values ('110', 'Amy', 'A', '107');
insert into Employee2 (id, name, department, managerId) values ('111', 'Anne', 'A', '107');
insert into Employee2 (id, name, department, managerId) values ('112', 'Ron', 'B', '107');
...
FROM (
    ...
    INNER JOIN Employee2 AS e2 ON e1.id=e2.managerId 
